...
\begin{frame}
	...
	zf num
	\end{block}
	\begin{block}{usuwanie}<2->
	zd
	\end{block}
	\begin{block}{usuwanie recursywne}<3->
	zD
	\end{block}
	\uncover<4->
	{
...
\begin{frame}
	...
	\{\{\{ oraz \}\}\}
	\end{block}
	\begin{block}{tworzenie alt.}<2->
	\{\{\{num oraz \}\}\}num
	\end{block}
	\begin{block}{tworzenie alt.2}<3->
	zf num
	\end{block}
	\begin{block}{usuwanie}<4->
	usuwamy znaczniki
	\end{block}
	\begin{block}{usuwanie alt.}<5->
	zd
	\end{block}
	\uncover<6->
	{
